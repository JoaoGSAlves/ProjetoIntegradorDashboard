...
import { ProximasAtividadesComponent } from './components/Dashboard/usuario-dashboard/proximas-atividades/proximas-atividades.component';
...
@NgModule({
	declarations: [
		...
		ArquivosPrivadosComponent,
		UltimosBadgesComponent,
